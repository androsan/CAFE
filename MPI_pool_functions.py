...
def MM_(attr2, attr3, attr4, attr5, attr6, attr1): #  attr2=Negatives,   attr3=faza,  attr4=grain_ID,  attr5=cas,  attr6=S
...
def MM(attr2, attr3, attr4, attr5, attr6, attr1):       #  attr2=Negatives,   attr3=faza,  attr4=grain_ID,  attr5=cas,  attr6=S
            ...
            return attr6
            #  attr2=Negatives,   attr3=faza,  attr4=grain_ID,  attr5=cas,  attr6=S
...
#               attr3= faza,  attr6= S,  attr14= cas,   attr2= Selection
def GG_(attr3, attr6, attr14, attr2):
#def GG_(attr3, attr2):
       grain=attr2[0]
       s=attr2[1]
       ''' ----------------------------------------- GROUP 1 ::: [001], [010] >>> 4 sites -------------------------------------------'''
       if s == '001':
           #faza001 = np.where((attr3==0)&(np.pad(attr3,((0,0),(0,0), (1,0)), 'constant')[:,:,:-1]==grain) , grain, attr3)
           #seznam_premikov.append(faza001); del faza001
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(0,0), (1,0)), 'constant')[:,:,:-1]==grain) , grain, attr3)

       elif s == '00_1':
           #faza00_1 = np.where((attr3==0)&(np.pad(attr3,((0,0),(0,0), (0,1)), 'constant')[:,:,1:]==grain), grain, attr3)
           #seznam_premikov.append(faza00_1); del faza00_1
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(0,0), (0,1)), 'constant')[:,:,1:]==grain), grain, attr3)

       elif s == '010':
           #faza010 = np.where((attr3==0)&(np.pad(attr3,((0,0),(1,0), (0,0)), 'constant')[:,:-1,:]==grain), grain, attr3)
           #seznam_premikov.append(faza010); del faza010
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(1,0), (0,0)), 'constant')[:,:-1,:]==grain), grain, attr3)

       elif s == '0_10':
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(0,1), (0,0)), 'constant')[:,1:,:]==grain), grain, attr3)

       elif s == '011':
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(1,0), (1,0)), 'constant')[:,:-1,:-1]==grain), grain, attr3)

       elif s == '01_1':
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(1,0), (0,1)), 'constant')[:,:-1,1:]==grain), grain, attr3)

       elif s == '0_11':
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(0,1), (1,0)), 'constant')[:,1:,:-1]==grain), grain, attr3)

       elif s == '0_1_1':
           attr3= np.where((attr3==0)&(np.pad(attr3,((0,0),(0,1), (0,1)), 'constant')[:,1:,1:]==grain), grain, attr3)

       #attr3 = seznam_premikov[0]             
       attr14 = attr6[s]

       #return attr3, attr14, attr6
       return attr3 #, attr14
        


def GG(attr1, attr3, attr4, attr5, attr6, attr7, attr8, attr9, attr10, attr11, attr12, attr13, attr14, attr15, attr2):
...
#    attr1= GDSM, attr2= Selection, attr3= faza, attr4= asc, attr5= vg, attr6= S
#    attr7= taula, attr8= T_next, attr9= T, attr10= likvid, attr11= R, attr12= cell
#    attr13= W, attr14= cas, attr15= random_distances 

 
''' ============================ POOL functions =============================================================================== '''

def GG_pool_wrong(attr1, attr4, attr11, attr12, attr13, attr15, ATTR2, part):
    faza, cas = GG(attr1, part[0], attr4, part[2], part[3], part[4], part[5], part[6], part[7], attr11, attr12, attr13, part[1], attr15, ATTR2[0])
    for attr2 in ATTR2[1:]:
        faza, cas = GG(attr1, part[0], attr4, part[2], part[3], part[4], part[5], part[6], part[7], attr11, attr12, attr13, part[1], attr15, attr2)
    return faza, cas

def GG_pool_return_all(GDSM, asc, R, cell, W, random_distances, Selection, part):
    faza=part[0]; cas=part[1]; vg=part[2]; S=part[3]; taula=part[4]; T_next=part[5]; T=part[6]; likvid=part[7]
    for attr2 in Selection:
        GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances = GG(GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances, attr2)
    return GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances


''' .................................................. the correct MPI pool function ............................................................................. '''

def GG_pool(GDSM, asc, R, cell, W, random_distances, Selection, part):
    faza=part[0]; cas=part[1]; vg=part[2]; S=part[3]; taula=part[4]; T_next=part[5]; T=part[6]; likvid=part[7]
    for attr2 in Selection:
        faza, cas = GG(GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances, attr2)
    return faza, cas

''' ........................................................................................................................................................................... '''

def GG_pool_no_partitions(attr1, attr4, attr5, attr6, attr7, attr8, attr9, attr10, attr11, attr12, attr13, attr15, ATTR2, part):
    attr3, attr14 = GG(attr1, part[0], attr4, attr5, attr6, attr7, attr8, attr9, attr10, attr11, attr12, attr13, part[1], attr15, ATTR2[0])
    for attr2 in ATTR2[1:]:
        attr3, attr14 = GG(attr1, part[0], attr4, attr5, attr6, attr7, attr8, attr9, attr10, attr11, attr12, attr13, part[1], attr15, attr2)
    return attr3, attr14


def for_loop_GG(GDSM, asc, vg, S, taula, T_next, T, likvid, R, cell, W, random_distances, Selection, fazacas):
    faza=fazacas[0]; cas=fazacas[1]
    for attr2 in Selection:
        faza, cas = GG(GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances, attr2)
    return faza, cas

def for_loop_GG_attrs(attr1, attr4, attr5, attr6, attr7, attr8, attr9, attr10, attr11, attr12, attr13, attr15, ATTR2, part):
    for attr2 in ATTR2:
        faza, cas = GG(attr1, part[0], attr4, attr5, attr6, attr7, attr8, attr9, attr10, attr11, attr12, attr13, part[1], attr15, attr2)
    return faza, cas


''' ============================ PROCESS functions =============================================================================== '''
      
def GG_process(GDSM, asc, R, cell, W, random_distances, Selection, part, Q1):
    #faza=part[0]; cas=part[1]; vg=part[2]; S=part[3]; taula=part[4]; T_next=part[5]; T=part[6]; likvid=part[7]
    #for attr2 in Selection:
     #   faza, cas = GG(GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances, attr2)
    #return faza, cas
    #faza=part[0]; cas=part[1]; vg=part[2]; S=part[3]; taula=part[4]; T_next=part[5]; T=part[6]; likvid=part[7]
    for attr2 in Selection:
        part[0], part[1] = GG(GDSM, faza, asc, vg, S, taula, T_next, T, likvid, R, cell, W, cas, random_distances, attr2)
    #Q1.put((faza, cas))
...
def arb_func(r,q):
    time.sleep(r)
    q.put('arc_func has worked'+str(r)+' seconds!')
